...
def train_model():
    ...
    data_module = ControlNetDataModule(
        image_latents_path="t2i_sfhq.h5",
        text_encodings_path="text_encodings.h5",
        batch_size=Config.batch_size,
        holdout_ids_file="holdout_ids.npy"
    )
    ...
    trainer = pl.Trainer(
        ...
        devices=1,
        precision="bf16",
        default_root_dir="./fine_tuned_models",
    ...
    import wandb
    wandb.finish()
    print("Training complete. Checkpoints saved in ./fine_tuned_models")
